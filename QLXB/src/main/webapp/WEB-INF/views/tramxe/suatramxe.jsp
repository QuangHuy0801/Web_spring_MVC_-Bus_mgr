   ...
   <%@ include file="../includes/Navbarc12.jsp" %>	
			...
			<div class="col py-3">
				...
				<div class="container form-dang-nhap">
					...
					<form:form action="updatetramxe.htm" modelAttribute="tramXe">
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col">
										<label for="recipient-name" class="col-form-label">Mã :</label> <form:input type="text" class="form-control"
											path="maSo" placeholder="QK 123" />
											<form:errors path="maSo" />
								...
								<div class="row">
									<div class="col">
										...
										<label for="recipient-name" class="col-form-label">Mã nhân viên cập nhật trạm : ${sessionScope.TaiKhoan.nhanVien.ho} ${sessionScope.TaiKhoan.nhanVien.ten}</label>
										<form:input type="text" class="form-control"
											path="nhanVienTaoTramXe.maNV" value="${sessionScope.TaiKhoan.nhanVien.maNV}" readonly="true"/> 
											<form:errors path="nhanVienTaoTramXe.maNV" />
