   ...
   <%@ include file="../includes/Navbarc13.jsp" %>	
			...
			<div class="col py-3">
				...
				<div class="container form-dang-nhap">
					...
					<form:form action="updatedoanhthutram.htm" modelAttribute="doanhThuTram">
						
							<div class="form-group">
								<div>
									<h1>Sửa doanh thu trạm</h1>  
								</div>
								<div class="row" style="display: none;">
								 <form:input type="text" class="form-control" path="doanhThuNgay.id" />
