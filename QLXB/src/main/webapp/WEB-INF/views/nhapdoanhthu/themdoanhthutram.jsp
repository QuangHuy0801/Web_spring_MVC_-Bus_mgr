   ...
   <%@ include file="../includes/Navbarc13.jsp" %>	
			...
			<div class="col py-3">
					...
					<div class="alert alert-success fade show" role="alert"style='position: fixed; width:50%; margin-left:300px; z-index: 100 '>
						...
						<p>Thêm doanh thu trạm thành công</p>
						<hr>
					</div>
				</c:if>
				<c:if test="${message==2}">
					<div class="alert alert-danger fade show" role="alert"style='position: fixed; width:50%; margin-left:230px;'>
						...
						<p>Thêm doanh thu trạm thất bại</p>
						<hr>
					</div>
					</c:if>
					<c:set var="message" value="0" />
					<button onclick="location.href = '../${idDTN}.htm'"  class="btn btn-outline-secondary my-2 my-sm-0" type="submit"> << Trở lại</button>
				<div class="container form-dang-nhap">
					<div class="modal-body">
					<form:form action="insertdoanhthutram.htm" modelAttribute="doanhThuTram">
						
							<div class="form-group">
								<div>
									<h1>Thêm doanh thu trạm</h1>  
								</div>
								<div class="row">
								 <form:input type="text" class="form-control" path="doanhThuNgay.id" value="${idDTN}" style="display: none;"/>
									</div>
									<div class="row">
									<div class="col">
										<label for="recipient-name" class="col-form-label">số vé tập
											 </label>  <form:input type="text" class="form-control" path="soVeTap"/>
											<form:errors path="soVeTap" />
									</div>
