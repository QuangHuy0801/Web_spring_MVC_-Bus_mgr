			...
			<div class="col py-3">
				...
				<c:if test="${message==2}">
					<div class="alert alert-danger fade show" role="alert"style='position: fixed; width:50%; margin-left:230px;'>
						...
						<p>Sửa doanh thu thất bại</p>
						<hr>
					</div>
					</c:if>
					<c:set var="message" value="0" />
					<button onclick="location.href = '../lichsunhap.htm'"  class="btn btn-outline-secondary my-2 my-sm-0" type="submit"> << Trở lại</button>
				<div class="container form-dang-nhap">
					<div class="modal-body">
					<form:form action="updatedoanhthu.htm" modelAttribute="doanhThuNgay">
							...
							<div class="form-group">
								...
								<div class="row">
											   ...
											   <form:input type="text" class="form-control" path="id" style="
    display: none;
"/>
									...
									<div class="row">
									<div class="col">
										<label for="recipient-name" class="col-form-label">số HSSV
											 </label>  <form:input type="text" class="form-control" path="soVeHSSV"/>
											<form:errors path="soVeHSSV" />
									</div>
									<div class="col">
										<label for="recipient-name" class="col-form-label">số bình thường
     ...
     <form:option  value="${tuyenduong.id}">${tuyenduong.ten}</form:option>
									...
									<div class="col">
										...
										<label for="recipient-name" class="col-form-label">Nhân viên nhập : ${sessionScope.TaiKhoan.nhanVien.ho} ${sessionScope.TaiKhoan.nhanVien.ten}</label>
										<form:input type="text" class="form-control"
											path="nhanVien_nhap.maNV" value="${sessionScope.TaiKhoan.nhanVien.maNV}" readonly="true"/> 
											<form:errors path="nhanVien_nhap.maNV" />
