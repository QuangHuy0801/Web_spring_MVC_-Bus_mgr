   ...
   <%@ include file="../includes/Navbarc12.jsp" %>	
			...
			<div class="col py-3">
				...
				<div class="container form-dang-nhap">
					...
					<form:form action="updatexe.htm" modelAttribute="xe">
									...
									<div class="col">
									 ...
									 <div class="col">
										...
										<div class="form-check form-check-inline">
											<form:radiobutton path="tinhTrang" value="1" label="Hoạt động tốt"  ></form:radiobutton> 
										</div>
										<div class="form-check form-check-inline">
