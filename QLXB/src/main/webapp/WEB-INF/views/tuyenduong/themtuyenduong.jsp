   ...
   <%@ include file="../includes/Navbarc11.jsp" %>	
			...
			<div class="col py-3">
				...
				<div class="container form-dang-nhap">
					...
					<form:form action="inserttuyenduong.htm" modelAttribute="tuyenDuong">
							...
							<div class="row">
							<div class="col">
										<label for="recipient-name" class="col-form-label" >Chọn giá vé :</label> 
											 <form:select path="giaVe.id" class="form-select" aria-label="Default select example">
											<c:forEach var="giave" items="${giaves}">
 
     <form:option  value="${giave.id}">Giá vé HSSV: ${giave.giaVeHSSV} - Giá vé BT: ${giave.giaVeBT} - Giá vé Tập: ${giave.giaVeTap} - Loại hình :${giave.loaiHinh}</form:option>
