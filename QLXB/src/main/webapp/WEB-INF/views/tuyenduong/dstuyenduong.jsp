...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
   <c:if test="${sessionScope.TaiKhoan.nhanVien.chucVu.id==1}"> <a class="navbar-brand " href="themtuyenduong.htm"> <button type="button" class="btn btn-success"
																data-dismiss="modal">Thêm Tuyến đường</button></a></c:if>
						...
						<c:set var="counter" value="${offset+1 }" />
							<c:forEach var="tuyenduong" items="${tuyenduongs}">
								...
								<tr>
									...
									<h6 class="font-weight-normal"> Giản cách: ${tuyenduong.gianCach} phút</h6><h6 class="font-weight-normal">Thời gian hoạt động: ${tuyenduong.thoiGianHD}h</h6>
									
									<h6 class="font-weight-normal">Thời gian một chuyến: ${tuyenduong.thoiGianChuyen} phút</h6>
									<h6 class="font-weight-normal">Cự ly: ${tuyenduong.cuLy} phút</h6>
